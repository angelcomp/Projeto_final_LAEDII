...
SDL_Renderer* kiss_init(char* title, kiss_array *a, int w, int h)
{
	...
	r += kiss_font_new(&kiss_textfont, "kiss_resources/kiss_font.ttf", a,
		kiss_textfont_size);
	r += kiss_font_new(&kiss_buttonfont, "kiss_resources/kiss_font.ttf", a,
		kiss_buttonfont_size);
	r += kiss_image_new(&kiss_normal, "kiss_resources/kiss_normal.png", a, renderer);
	r += kiss_image_new(&kiss_prelight, "kiss_resources/kiss_prelight.png", a, renderer);
	r += kiss_image_new(&kiss_active, "kiss_resources/kiss_active.png", a, renderer);
	r += kiss_image_new(&kiss_bar, "kiss_resources/kiss_bar.png", a, renderer);
	r += kiss_image_new(&kiss_vslider, "kiss_resources/kiss_vslider.png", a, renderer);
	r += kiss_image_new(&kiss_hslider, "kiss_resources/kiss_hslider.png", a, renderer);
	r += kiss_image_new(&kiss_up, "kiss_resources/kiss_up.png", a, renderer);
	r += kiss_image_new(&kiss_down, "kiss_resources/kiss_down.png", a, renderer);
	r += kiss_image_new(&kiss_left, "kiss_resources/kiss_left.png", a, renderer);
	r += kiss_image_new(&kiss_right, "kiss_resources/kiss_right.png", a, renderer);
	r += kiss_image_new(&kiss_combo, "kiss_resources/kiss_combo.png", a, renderer);
	r += kiss_image_new(&kiss_selected, "kiss_resources/kiss_selected.png", a, renderer);
	r += kiss_image_new(&kiss_unselected, "kiss_resources/kiss_unselected.png", a,
		renderer);
	if (r) {
		kiss_clean(a);
		return NULL;
